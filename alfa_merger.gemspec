...
Gem::Specification.new do |spec|
  ...
  spec.summary = 'ALFA Bank CSV export transaction merger for Firefly III'
  spec.description = 'ALFA Bank CSV export transaction merger for Firefly III'
